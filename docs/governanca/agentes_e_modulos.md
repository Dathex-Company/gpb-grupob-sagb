...
- `src/modules/monitoramento/agent/prompt-ativacao-cline.md`
- `src/modules/monitoramento/agent/session-log.md`
...
3. [ ] Validar que todos os owners ativos têm `prompt-ativacao-cline.md`
