...
| GOV-CAM-003 | camada_tecnica | Protocolo de Log Contínuo de Agentes | Log Contínuo de Agentes | ativo | EXISTE | `docs/governanca_sagb/protocolo_log_continuo_agentes.md` | Logs por agente/módulo (`agent/session_log.md`) | `src/modules/*/agent/session_log.md` | `docs/governanca_sagb/protocolo_log_continuo_agentes.md` | Define o padrão de registro turno a turno para conversas operacionais de agentes |
| GOV-PAP-001 | papel_institucional | Orquestração Sistêmica | Pierre Zanulli | ativo | PARCIAL | Diretriz executiva de governança (conversa e catálogo) | `DEV_LOG.md` (quando aplicável) | N/A | `docs/governanca_sagb/*` | Formalizar escopo decisório e integração com owners de módulo |
