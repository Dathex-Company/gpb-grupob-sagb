  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#0a0a0f] to-[#15151f] p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-10">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              <button
                onClick={() => setShowSuperTela(true)}
                className="px-6 py-3 bg-gradient-to-r from-cyan-500 to-indigo-600 text-white font-bold rounded-xl hover:from-cyan-600 hover:to-indigo-700 transition-all duration-300 shadow-lg shadow-cyan-500/20 hover:shadow-cyan-500/30"
              >
                Super Tela SagB
              </button>
              <button
        ...
        {/* Super Tela SagB */}
        {showSuperTela && (
          <SuperTelaSagBPanel onClose={() => setShowSuperTela(false)} />
        )}
      </div>
    </div>
  );
