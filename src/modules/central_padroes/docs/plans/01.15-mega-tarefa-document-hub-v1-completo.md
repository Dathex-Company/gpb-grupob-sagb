...
| Arquivo | Papel |
|---|---|
| `01.12-plano-execucao-consolidado-document-hub-v1.md` | Plano consolidado P0/P1/P2. |
| `01.13-plano-r5-document-hub.md` | Plano R5 original. |
| `01.14-recomendacoes-pre-r5.md` | Revisão do R5, removendo itens já executados. |
| `01.15-mega-tarefa-document-hub-v1-completo.md` | Mega plano unificado. |
| `01.16-execucao-onda-0-baseline-document-hub-v1.md` | Próximo arquivo sugerido para registrar baseline real. |
| `01.17-execucao-onda-1-contrato-documental-document-hub-v1.md` | Próximo arquivo sugerido para registrar execução da Onda 1. |
| `01.18-execucao-onda-2-detalhe-navegacao-document-hub-v1.md` | Próximo arquivo sugerido para registrar execução da Onda 2. |
...
```text
01.16-execucao-onda-0-baseline-document-hub-v1.md
01.17-execucao-onda-1-contrato-documental-document-hub-v1.md
01.18-execucao-onda-2-detalhe-navegacao-document-hub-v1.md
01.19-execucao-onda-3-busca-pietro-listas-document-hub-v1.md
01.20-execucao-onda-4-governanca-operacional-document-hub-v1.md
01.21-autorizacao-r5-schema-rls-rpc-storage-document-hub-v1.md
01.22-execucao-r5-persistencia-document-hub-v1.md
01.23-execucao-editor-markdown-persistente-document-hub-v1.md
01.24-fechamento-mega-tarefa-document-hub-v1.md
```
