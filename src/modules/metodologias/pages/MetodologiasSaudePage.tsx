  ...
  return (
    <div className="space-y-6">
      <header className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-black tracking-tight text-sagb-text">Saúde e Cobertura do Núcleo</h1>
          <p className="text-[12px] text-sagb-muted mt-1">Leitura executiva de maturidade e integridade metodológica.</p>
        </div>
        <button
          type="button"
          onClick={onVoltar}
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
        ...
        <section className="space-y-4 xl:col-span-1">
          <h3 className="text-[12px] font-black uppercase tracking-wide text-sagb-text">Maturidade & Escopo</h3>
          <div className="grid grid-cols-2 gap-3">
            <article className="rounded-xl border border-sagb-line bg-sagb-panel p-4">
              <p className="text-[10px] font-black uppercase tracking-wide text-sagb-muted">Entradas Brutas</p>
              <p className="text-xl font-black text-sagb-text mt-1">{visaoGeral.totalEntradasBrutas}</p>
            </article>
            <article className="rounded-xl border border-sagb-line bg-sagb-panel p-4">
              <p className="text-[10px] font-black uppercase tracking-wide text-sagb-muted">Em Estruturação</p>
            ...
            <article className="rounded-xl border border-indigo-500/20 bg-indigo-500/10 p-4">
              <p className="text-[10px] font-black uppercase tracking-wide text-indigo-500">Canônicos</p>
              <p className="text-xl font-black text-indigo-500 mt-1">{visaoGeral.totalCanonicos}</p>
            </article>
            <article className="rounded-xl border border-sagb-line bg-sagb-panel p-4">
              <p className="text-[10px] font-black uppercase tracking-wide text-sagb-muted">Com Manutenção 30d</p>
        ...
        {/* Cobertura */}
        <section className="space-y-4 xl:col-span-1">
          <h3 className="text-[12px] font-black uppercase tracking-wide text-sagb-text">Cobertura Canônica</h3>
          <div className="rounded-2xl border border-sagb-line bg-sagb-panel p-1 overflow-hidden">
            <div className="space-y-1">
              ...
              <div className="flex items-center justify-between p-3 rounded-xl bg-sagb-bg-2">
                <span className="text-[12px] font-semibold text-sagb-text">Snapshots Íntegros</span>
        ...
        {/* Atenção */}
        <section className="space-y-4 xl:col-span-1">
          <h3 className="text-[12px] font-black uppercase tracking-wide text-rose-500">Pontos de Atenção</h3>
          <div className="grid grid-cols-1 gap-3">
            <article className="rounded-xl border border-rose-500/20 bg-rose-500/10 p-4 flex items-center justify-between">
              <div>
                <p className="text-[12px] font-bold text-rose-500">Canônicos sem corpo</p>
            ...
            <article className="rounded-xl border border-rose-500/20 bg-rose-500/10 p-4 flex items-center justify-between">
              <div>
                <p className="text-[12px] font-bold text-rose-500">Canônicos isolados</p>
            ...
            <article className="rounded-xl border border-amber-500/20 bg-amber-500/10 p-4 flex items-center justify-between">
              <div>
                <p className="text-[12px] font-bold text-amber-500">Canônicos sem snapshot</p>
            ...
            <article className="rounded-xl border border-amber-500/20 bg-amber-500/10 p-4 flex items-center justify-between">
              <div>
                <p className="text-[12px] font-bold text-amber-500">Estruturação parada</p>
