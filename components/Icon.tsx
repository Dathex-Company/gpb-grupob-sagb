...
export const ShieldCheckIcon = ({ className }: { className?: string }) => (
  <BaseIcon d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" className={className} />
);

export const CubeIcon = ({ className }: { className?: string }) => (
  <BaseIcon d="M21 16V8a2 2 0 00-1-1.73l-7-4a2 2 0 00-2 0l-7 4A2 2 0 003 8v8a2 2 0 001 1.73l7 4a2 2 0 002 0l7-4A2 2 0 0021 16z" className={className} />
);

export const MailIcon = ({ className }: { className?: string }) => (
  <BaseIcon d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" className={className} />
);
